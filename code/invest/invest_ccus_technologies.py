                ...
                if nT > 0:
                    ...
                    if remaining_gap > 0:
                        ...
                        while remaining_gap > 0:
                            ...
                            if iT > nT:
                                print(f"!!!!Warning: There is not enough available max capacity to satisfy the demand for {activities[iA]}, the remaining gap is {-remaining_gap:6.2f} UoA") # Display a warning message
                                remaining_gap = 0
